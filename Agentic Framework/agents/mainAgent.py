        ...
        for i, op in enumerate(operations, 1):
                ...
                if objects_to_update:
                    ...
                    for obj in objects_to_update:
                        ...
                        if result.get('status') == 'success':
                            ...
                            error_msg = result.get('result') or result.get('error') or "Unknown error"
                            errors.append(f"Failed to update {obj_name}: {error_msg}")
            ...
            if is_bulk and count > 0:
                ...
                if bulk_result.get('status') == 'success':
                    ...
                    error_msg = bulk_result.get('error') or bulk_result.get('result') or "Bulk create failed"
