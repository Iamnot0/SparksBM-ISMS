...
"""
    ...
    def _resolveToId(self, objectType: str, message: str, domainId: str) -> Optional[str]:
        ...
        logger.info(f"[_resolveToId] Resolving '{name}' (type: {objectType}) in domain '{domainId}'")
        ...
        if domainId:
            for attempt in range(max_retries):
                ...
                if result:
                    ...
                    return result
                logger.debug(f"[_resolveToId] Object '{name}' not found in default domain (attempt {attempt + 1}/{max_retries}). Retrying in {delay_seconds}s...")
