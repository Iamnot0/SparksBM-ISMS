...
sys.path.insert(0, str(Path(__file__).resolve().parent.parent.parent / "Agentic Framework"))
    ...
    if engine.isAvailable():
        ...
        try:
            ...
            if "quota" in error_msg.lower() or "exhausted" in error_msg.lower():
                ...
                print("\n   📊 Error Analysis:")
                print("   - Type: Location Restriction")
                print("   - Cause: Gemini API not available in this region")
                print("   - Solution: Use a VPN or check supported regions")
            else:
                print("\n   📊 Error Analysis:")
